                    ...
                    <div class="col-lg-6 col-12 mb-4">
                        <div class="custom-block bg-white shadow-lg p-4">
                            ...
                            <div class="button-group">
                                <button id="undergradYes" class="custom-button"
                                    onclick="selectOption('undergraduate', true, 'undergradYes', 'undergradNo')">Yes</button>
                                <button id="undergradNo" class="custom-button"
                                    onclick="selectOption('undergraduate', false, 'undergradNo', 'undergradYes')">No</button>
                            </div>
                            <h3>Are you enrolled in a Non-IT degree program?</h3>
                            <div class="button-group">
                                <button id="nonITYes" class="custom-button"
                                    onclick="selectOption('nonIT', true, 'nonITYes', 'nonITNo')">Yes</button>
                                <button id="nonITNo" class="custom-button"
                                    onclick="selectOption('nonIT', false, 'nonITNo', 'nonITYes')">No</button>
                            </div>
                            <button class="custom-button" onclick="checkEligibility()">Continue</button>
                            <p id="eligibility-message">Sorry.. This system is mainly targeted for the State University
                                Non-IT undergraduates</p>
                    ...
                    <div class="col-lg-6 col-12">
                        <form action="#" method="post" class="custom-form contact-form" role="form"
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="form-floating">
                                        <select name="university" id="university" class="form-control" required>
                                            ...
                                            <option value="gzu">Gampaha Wickramarachchi University of Indigenous
                                                Medicine</option>
                                ...
                                <div class="col-lg-12 col-12">
                                    <div class="form-floating">
                                        <select name="district_of_residence" id="district_of_residence"
    ...
    <script>
        ...
        function checkEligibility() {
            if (isUndergraduate === true && isNonIT === true) {
                ...
                $("#formEligible").addClass("d-none").hide();
            }
        }
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <a href="${response.redirect}" class="btn btn-primary mt-2">Join Quiz</a>
                            </div>
                        `);
                            $("#checkUserForm")[0].reset(); // Reset the form after success
                        },
                        error: function(xhr) {
