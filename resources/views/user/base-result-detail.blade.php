...
@section('main')
    ...
    <div class="container">
        <div class="result-header">Base Quiz - Quiz Details</div>
        <div class="result-sub-header">Graded Quiz • In the course Base Quiz</div>

        <div class="row mt-5">
            <div class="col-md-4">
                <div class="score">
                    <label for="Awarded score">Storage and device hygiene</label>
                    <h3>{{ $result['storage_dovice_score'] }}%</h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="score">
                    <label for="Awarded score">Transmission & browsing hygiene</label>
                    <h3>{{ $result['transmission_browsing_score'] }}%</h3>
                </div>
            </div>
            <div class="col-md-4">
                <div class="score">
                    <label for="Awarded score">Fb & social media hygiene</label>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <!-- Empty column or additional content here -->
            </div>
        </div>
        ...
        @if ($level == 1 || $level == 2)
            <div class="text-center mt-5">
                <a href="/base-quiz/1" class="btn custom-btn custom-border-btn ms-3">Improve your hygiene</a>
            </div>
        @elseif ($level == 3)
            <div class="text-center mt-5">
                <a href="/register" class="btn custom-btn custom-border-btn ms-3">Congratulations! You have reached the
                    highest
                    level</a>
            </div>
        @endif
